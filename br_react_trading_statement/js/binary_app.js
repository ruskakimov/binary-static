...
var createLanguageDropDown = __webpack_require__(156);
var BinarySocket = __webpack_require__(5);
var getElementById = __webpack_require__(3).getElementById;
var Crowdin = __webpack_require__(119);
...
var Client = __webpack_require__(4);
var Password = __webpack_require__(148);
var localize = __webpack_require__(2).localize;
...
var getFormNameBarrierCategory = __webpack_require__(43).getFormNameBarrierCategory;
var getLanguage = __webpack_require__(13).get;
var localize = __webpack_require__(2).localize;
var getPropertyValue = __webpack_require__(0).getPropertyValue;
var isEmptyObject = __webpack_require__(0).isEmptyObject;
...
var moment = __webpack_require__(9);
var ViewPopupUI = __webpack_require__(75);
var Highchart = __webpack_require__(160);
...
var updateWarmChart = __webpack_require__(43).updateWarmChart;
var DigitInfo = __webpack_require__(159);
var Defaults = __webpack_require__(25);
var getActiveTab = __webpack_require__(122).getActiveTab;
var Purchase = __webpack_require__(124);
var Tick = __webpack_require__(36);
var TickDisplay = __webpack_require__(72);
var MBDefaults = __webpack_require__(28);
...
var Portfolio = __webpack_require__(163).Portfolio;
...
var MetaTraderUI = __webpack_require__(164);
var Client = __webpack_require__(4);
var BinarySocket = __webpack_require__(5);
var Validation = __webpack_require__(49);
var localize = __webpack_require__(2).localize;
...
var _tooltip = __webpack_require__(363);
...
var _dao = __webpack_require__(126);
...
var _duration = __webpack_require__(372);
...
var _subscription_manager = __webpack_require__(366);
...
var DAO = function () {
    ...
    var getStatement = function getStatement(limit, offset, date_boundaries) {
        return _socket2.default.send(_extends({
            statement: 1,
            description: 1,
            limit: limit,
            offset: offset
...
var _statement = __webpack_require__(368);
...
var RouteWithSubRoutes = function RouteWithSubRoutes(route) {
    return _react2.default.createElement(_reactRouterDom.Route, {
        ...
        render: function render(props) {
            return route.is_authenticated && !_client2.default.isLoggedIn() ? // TODO: update styling of the message below
            _react2.default.createElement(
                'a',
...
var BinarySocket = __webpack_require__(5);
var BinarySocketGeneral = __webpack_require__(153);
var getElementById = __webpack_require__(3).getElementById;
var localize = __webpack_require__(2).localize;
...
var Mellt = __webpack_require__(149);
var localize = __webpack_require__(2).localize;
...
var CommonPasswords = __webpack_require__(150);
...
var SessionDurationLimit = __webpack_require__(157);
var updateBalance = __webpack_require__(165);
var State = __webpack_require__(6).State;
var urlFor = __webpack_require__(8).urlFor;
var getPropertyValue = __webpack_require__(0).getPropertyValue;
...
var HighchartUI = __webpack_require__(161);
...
var _contract_type = __webpack_require__(369);

var ContractType = _interopRequireWildcard(_contract_type);

var _currency = __webpack_require__(370);
...
var _start_date = __webpack_require__(373);
...
var _popover = __webpack_require__(361);
...
var _drawer = __webpack_require__(359);

var _language_switcher = __webpack_require__(360);

var _language_switcher2 = _interopRequireDefault(_language_switcher);

var _account_switcher = __webpack_require__(357);
...
var SubscriptionManager = function () {
    ...
    var subscribe = function subscribe(msg_type, request_obj, fncCallback) {
        ...
        if (!sub_id) {
            ...
            _socket2.default.send(request_obj, {
    ...
    var forgetAll = function forgetAll() {
        ...
        return Promise.resolve(!(0, _utility.isEmptyObject)(types_to_forget) ? _socket2.default.send({ forget_all: Object.keys(types_to_forget) }) : {});
    };

    var forgetStream = function forgetStream(stream_id) {
        return Promise.resolve(stream_id ? _socket2.default.send({ forget: stream_id }) : {});
    };
...
var _network_monitor = __webpack_require__(145);
...
var _data_table = __webpack_require__(358);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'span',
                            { className: 'statement-filter-text' },
                            (0, _localize.localize)('Filter by date:')
                        ),
                        _react2.default.createElement(
                            'span',
                            { className: 'statement-filter-text' },
                            (0, _localize.localize)('from')
                        ),
                ...
                _react2.default.createElement(
                    ...
                    ) || this.state.data_source.length === 0 && _react2.default.createElement(
                        _react2.default.Fragment,
                        null,
                        _react2.default.createElement(_data_table2.default, {
                            data_source: [],
...
var Contract = function Contract(_ref) {
    var contract_type = _ref.contract_type,
        contract_types_list = _ref.contract_types_list,
        onChange = _ref.onChange;
    return _react2.default.createElement(_contracts_popup2.default, {
        name: 'contract_type',
    ...
    return _react2.default.createElement(
        ...
        expiry_type === 'duration' ? _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                duration_unit === 'd' ? _react2.default.createElement(_date_picker2.default, {
                    name: 'duration',
            ...
            _react2.default.createElement(_time_picker2.default, { onChange: onChange, name: 'expiry_time', value: expiry_time, placeholder: '12:00 pm' })
        )
    );
};
...
var ContractsPopUp = function (_React$PureComponent) {
    ...
    _createClass(ContractsPopUp, [{
        ...
        value: function render() {
            ...
            var prefix_class = 'contracts-popup-container';
            var suffix_class = 'desktop-only';
...
var StartDate = function StartDate(_ref) {
    ...
    return _react2.default.createElement(
        ...
        start_date !== 'now' && _react2.default.createElement(
            _react2.default.Fragment,
            null,
            _react2.default.createElement(_time_picker2.default, { onChange: onChange, name: 'start_time', value: start_time, placeholder: '12:00 pm' })
        )
    );
};
...
var _portfolio_drawer = __webpack_require__(362);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.isVisible('start_date') && _react2.default.createElement(_start_date2.default, null),
                    _react2.default.createElement(_duration2.default, null),
                    this.isVisible('barrier') && _react2.default.createElement(_barrier2.default, null),
                    this.isVisible('last_digit') && _react2.default.createElement(_last_digit2.default, null),
                    _react2.default.createElement(_amount2.default, null),
