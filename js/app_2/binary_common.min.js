...
/*!********************************************!*\
  ...
  \********************************************/
/*! no static exports found */function(e,a,o){"use strict";var r=Object.assign||function(e){for(var a=1;a<arguments.length;a++){var o=arguments[a];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(e[r]=o[r])}return e},n=o(/*! js-cookie */"./node_modules/js-cookie/src/js.cookie.js"),i=o(/*! moment */"./node_modules/moment/moment.js"),t=o(/*! ./client_base */"./src/javascript/_common/base/client_base.js"),s=o(/*! ./login */"./src/javascript/_common/base/login.js"),l=o(/*! ./socket_base */"./src/javascript/_common/base/socket_base.js"),c=o(/*! ../common_functions */"./src/javascript/_common/common_functions.js").getElementById,m=o(/*! ../common_functions */"./src/javascript/_common/common_functions.js").isVisible,d=o(/*! ../language */"./src/javascript/_common/language.js").get,u=o(/*! ../storage */"./src/javascript/_common/storage.js").State,h=function(){var e=function(e){s.isLoginPages()||dataLayer.push(r({},r({language:d(),pageTitle:a(),pjax:u.get("is_loaded_by_pjax"),url:document.URL},t.isLoggedIn()&&{visitorId:t.get("loginid"),bom_email:t.get("email")}),e))},a=function(){var e=/^.+[:-]\s*(.+)$/.exec(document.title);return e&&e[1]?e[1]:document.title};return{pushDataLayer:e,eventHandler:function(a){var o="1"===localStorage.getItem("GTM_login"),r="1"===localStorage.getItem("GTM_new_account");if(o||r){localStorage.removeItem("GTM_login"),localStorage.removeItem("GTM_new_account");var s=n.getJSON("affiliate_tracking");s&&e({bom_affiliate_token:s.t});var c={visitorId:t.get("loginid"),bom_currency:t.get("currency"),bom_country:a.country,bom_country_abbrev:a.country_code,bom_email:a.email,url:window.location.href,bom_today:Math.floor(Date.now()/1e3),event:r?"new_account":"log_in"};r&&(c.bom_date_joined=c.bom_today),t.get("is_virtual")||(c.bom_age=parseInt((i().unix()-a.date_of_birth)/31557600),c.bom_firstname=a.first_name,c.bom_lastname=a.last_name,c.bom_phone=a.phone),o?l.wait("mt5_login_list").then(function(a){(a.mt5_login_list||[]).forEach(function(e){var a=(t.getMT5AccountType(e.group)||"").replace("real_vanuatu","financial").replace("vanuatu_","").replace("costarica","gaming");a&&(c["mt5_"+a+"_id"]=e.login)}),e(c)}):e(c)}},pushPurchaseData:function(a){if(!t.get("is_virtual")){var o=a.buy;if(o){var r=a.echo_req.passthrough,n={event:"buy_contract",bom_ui:"old",bom_symbol:r.symbol,bom_market:c("contract_markets").value,bom_currency:r.currency,bom_contract_type:r.contract_type,bom_contract_id:o.contract_id,bom_transaction_id:o.transaction_id,bom_buy_price:o.buy_price,bom_payout:o.payout};Object.assign(n,{bom_amount:r.amount,bom_basis:r.basis,bom_expiry_type:c("expiry_type").value}),"duration"===n.bom_expiry_type&&Object.assign(n,{bom_duration:r.duration,bom_duration_unit:r.duration_unit}),m(c("barrier"))?n.bom_barrier=r.barrier:m(c("barrier_high"))&&(n.bom_barrier_high=r.barrier,n.bom_barrier_low=r.barrier2),m(c("prediction"))&&(n.bom_prediction=r.barrier),e(n)}}},mt5NewAccount:function(a){var o=a.mt5_new_account.mt5_account_type?a.mt5_new_account.account_type+"_"+a.mt5_new_account.mt5_account_type:("demo"===a.mt5_new_account.account_type?"demo":"real")+"_gaming",r={event:"mt5_new_account",bom_email:t.get("email"),bom_country:u.getResponse("get_settings.country"),mt5_last_signup:o};r["mt5_"+o+"_id"]=a.mt5_new_account.login,/demo/.test(o)&&!t.get("is_virtual")&&(r.visitorId=t.getAccountOfType("virtual").loginid),e(r)},setLoginFlag:function(){localStorage.setItem("GTM_login","1")}}}();e.exports=h},"./src/javascript/_common/base/login.js":
/*!**********************************************!*\
